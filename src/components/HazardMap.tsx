      ...
      <div className="w-full h-full bg-slate-900 relative">
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
          <div className="relative">
            <div className="w-4 h-4 bg-neon-green rounded-full shadow-[0_0_20px_#00ff9d] animate-pulse"></div>
            <div className="absolute -top-8 -left-12 bg-black/90 text-white text-[10px] px-2 py-1 rounded border border-neon-green/30 whitespace-nowrap">
              ESP32_01 (Safe)
            </div>
          </div>
        </div>
